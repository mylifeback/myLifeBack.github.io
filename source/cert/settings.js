/**
 * Node-RED Settings created at Thu, 01 Feb 2024 02:40:47 GMT
 *
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "pc",
            password: "$2b$08$3AF48E0YlRc9rfoe9nnRse4y7jluukmczoj/0inu7nVinoGBz1pQC",
	    permissions: "*"
        }]
    },
    ...
    https: {
      key: require("fs").readFileSync('/home/pi/cert/key.pem'),
      cert: require("fs").readFileSync('/home/pi/cert/cert.pem')
    },
